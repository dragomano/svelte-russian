...
Итерация по значениям может быть выполнена с помощью блока `each`. Значения, по которым осуществляется итерация, могут быть массивами, массивоподобными объектами (т. е. любыми объектами, у которых есть свойство `length`), или итерируемыми объектами, такими как `Map` и `Set`. (Внутри они преобразуются в массивы с помощью [`Array.from`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/from).)
