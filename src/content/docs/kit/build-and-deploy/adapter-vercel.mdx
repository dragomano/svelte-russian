...
Если вам нужны специфические для Vercel утилиты, такие как `waitUntil`, используйте пакет [`@vercel/functions`](https://vercel.com/docs/functions/functions-api-reference/vercel-functions-package).
