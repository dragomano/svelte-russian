...
При возникновении [_неожиданной_](https://svelte.dev/docs/kit/errors#Unexpected-errors) ошибки SvelteKit вызовет [`handleError`](/kit/advanced/hooks/#handleerror) и обработает её как 500 Internal Error.
