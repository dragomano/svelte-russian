...
Это изменение было внесено для обеспечения [большей конфигурируемости](../custom-elements#параметры-компонента) для продвинутых случаев использования. Скрипт миграции автоматически скорректирует ваш код. Также немного изменилось время обновления свойств. ([#8457](https://github.com/sveltejs/svelte/issues/8457))
